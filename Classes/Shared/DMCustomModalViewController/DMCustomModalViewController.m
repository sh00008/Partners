...
@property (nonatomic, retain, readwrite) UIView *overlayView;
@property (nonatomic, retain) UITapGestureRecognizer *tapGesture;
@property (nonatomic, retain) UIPanGestureRecognizer *panGesture;
@property (nonatomic, retain) UIPanGestureRecognizer *panFullView;
@property (nonatomic, retain) UINavigationBar *contentNavBar;
